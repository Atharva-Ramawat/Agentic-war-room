...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'LogAnalyzeResult': EventHandler<never, never>
    'AnalyzeAPI': ApiRouteHandler<Record<string, unknown>, ApiResponse<200, { status?: string; requestId?: string }>, { topic: 'analyze-request'; data: never }>
    ...
    'AnalyzeStep': EventHandler<never, { topic: 'analyze-result'; data: never }>
  }
